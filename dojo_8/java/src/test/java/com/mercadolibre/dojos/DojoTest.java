...
public class DojoTest {
    ...
    public void onlyToAgree() throws FileNotFoundException {
        ...
        Assert.assertEquals(InconsistencyCalculator.Inconsistency.ONLY_TO_AGREE, inconsistency);
    }
    ...
    public void cantSentXUnits() throws FileNotFoundException {
        ...
        checkoutContext.setCheckoutOptionsDto(checkoutOptionsDto);
        int inconsistency = InconsistencyCalculator.getInconsistencyValue(checkoutContext);
        Assert.assertEquals(InconsistencyCalculator.Inconsistency.CANT_SENT_X_UNITS, inconsistency);
    }
    ...
    public void agreeAgree() throws FileNotFoundException {
        ...
        checkoutContext.setCheckoutOptionsDto(checkoutOptionsDto);
        int inconsistency = InconsistencyCalculator.getInconsistencyValue(checkoutContext);
        Assert.assertEquals(InconsistencyCalculator.Inconsistency.AGREE_AGREE, inconsistency);
    }
    ...
    public void onlyCanBeSent() throws FileNotFoundException {
        ...
        checkoutContext.setCheckoutOptionsDto(checkoutOptionsDto);
        int inconsistency = InconsistencyCalculator.getInconsistencyValue(checkoutContext);
        Assert.assertEquals(InconsistencyCalculator.Inconsistency.ONLY_CAN_BE_SENT, inconsistency);
    }
    ...
    public void onlyPuis() throws FileNotFoundException {
        ...
        checkoutContext.setCheckoutOptionsDto(checkoutOptionsDto);
        int inconsistency = InconsistencyCalculator.getInconsistencyValue(checkoutContext);
        Assert.assertEquals(InconsistencyCalculator.Inconsistency.ONLY_PUIS, inconsistency);
    }
